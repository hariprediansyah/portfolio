...
const AllProjectsPage = ({ isDark, language, toggleTheme, toggleLanguage }) => {
  const [searchTerm, setSearchTerm] = useState('');
  const [selectedCategory, setSelectedCategory] = useState('all');
  const navigate = useNavigate();

  // Content dengan bahasa Indonesia yang natural
  const content = {
    en: {
      title: 'All Projects',
      ...
      projects: [
        {
          ...
          description: 'Modern e-commerce solution with React and Laravel backend, featuring payment integration, inventory management, and admin dashboard.',
        ...
        },
        {
          ...
          description: 'Secure banking application built with Flutter, featuring biometric authentication, transaction history, and real-time notifications.',
        ...
        },
        {
          ...
          description: 'Data visualization desktop application using .NET, providing comprehensive analytics dashboard for business intelligence.',
        ...
        },
        {
          ...
          description: 'Microservices architecture with Node.js and MongoDB, handling authentication, rate limiting, and service orchestration.',
        ...
        },
        {
          ...
          description: 'WebSocket-powered chat application with React, featuring group chats, file sharing, and emoji reactions.',
        ...
        },
        {
          ...
          description: 'Complete restaurant management solution with POS system, inventory tracking, and customer management.',
        ...
        },
        {
          ...
          description: 'Desktop application for warehouse inventory management with barcode scanning and reporting features.',
        ...
        },
        {
          ...
          description: 'Collaborative task management application with team workspaces, kanban boards, and time tracking.',
    ...
    id: {
      title: 'Semua Proyek',
      subtitle: 'Showcase lengkap dari karya pengembangan saya di berbagai platform dan teknologi',
      ...
      projects: [
        {
          ...
          description: 'Solusi e-commerce modern dengan React dan backend Laravel, dilengkapi integrasi pembayaran, manajemen inventori, dan dashboard admin.',
          tech: ['React', 'Laravel', 'MySQL', 'Tailwind CSS', 'Stripe API'],
          category: 'web',
          github: 'https://github.com/hariprediansyah/ecommerce-platform',
          live: 'https://ecommerce-demo.com',
        ...
        },
        {
          ...
          description: 'Aplikasi perbankan yang aman dibangun dengan Flutter, dilengkapi autentikasi biometrik, riwayat transaksi, dan notifikasi real-time.',
          tech: ['Flutter', 'Dart', 'Firebase', 'SQLite', 'Biometric Auth'],
          category: 'mobile',
          github: 'https://github.com/hariprediansyah/banking-app',
          featured: true
        },
        {
          ...
          description: 'Aplikasi desktop visualisasi data menggunakan .NET, menyediakan dashboard analytics komprehensif untuk business intelligence.',
          tech: ['.NET', 'C#', 'SQL Server', 'WPF', 'Chart.js'],
          category: 'desktop',
          github: 'https://github.com/hariprediansyah/analytics-tool',
          featured: true
        },
        {
          ...
          description: 'Arsitektur microservices dengan Node.js dan MongoDB, menangani autentikasi, rate limiting, dan orkestrasi layanan.',
          tech: ['Node.js', 'Express', 'MongoDB', 'Docker', 'Redis'],
          category: 'backend',
          github: 'https://github.com/hariprediansyah/api-gateway',
          featured: true
        },
        {
          ...
          description: 'Aplikasi chat bertenaga WebSocket dengan React, dilengkapi grup chat, berbagi file, dan reaksi emoji.',
          tech: ['React', 'Socket.io', 'Node.js', 'PostgreSQL', 'Redis'],
          category: 'web',
          github: 'https://github.com/hariprediansyah/chat-app',
          live: 'https://chat-demo.com',
        ...
        },
        {
          ...
          description: 'Solusi manajemen restoran lengkap dengan sistem POS, tracking inventori, dan manajemen pelanggan.',
          tech: ['Vue.js', 'Laravel', 'MySQL', 'Vuetify', 'Chart.js'],
          category: 'fullstack',
          github: 'https://github.com/hariprediansyah/restaurant-system',
          live: 'https://restaurant-demo.com'
        ...
        {
          title: 'Aplikasi Mobile Fitness Tracker',
          description: 'Aplikasi pelacakan kebugaran cross-platform dengan rencana workout, tracking progress, dan fitur sosial.',
          tech: ['React Native', 'Firebase', 'Redux', 'AsyncStorage', 'Charts'],
          category: 'mobile',
          github: 'https://github.com/hariprediansyah/fitness-tracker'
        },
        {
          ...
          description: 'Platform edukasi dengan manajemen kursus, streaming video, kuis, dan tracking progress.',
          tech: ['Next.js', 'Prisma', 'PostgreSQL', 'Tailwind CSS', 'Stripe'],
          category: 'fullstack',
          github: 'https://github.com/hariprediansyah/lms-platform',
          live: 'https://lms-demo.com'
        ...
        {
          title: 'Aplikasi Desktop Manajemen Inventori',
          description: 'Aplikasi desktop untuk manajemen inventori gudang dengan fitur barcode scanning dan laporan.',
          tech: ['Electron', 'React', 'SQLite', 'Chart.js', 'Barcode Scanner'],
          category: 'desktop',
          github: 'https://github.com/hariprediansyah/inventory-app'
        },
        {
          title: 'API Media Sosial',
          description: 'RESTful API untuk platform media sosial dengan manajemen user, posting, komentar, dan notifikasi real-time.',
          tech: ['Node.js', 'MongoDB', 'JWT', 'Socket.io', 'Cloudinary'],
          category: 'backend',
          github: 'https://github.com/hariprediansyah/social-api'
        },
        {
          ...
          description: 'Aplikasi manajemen tugas kolaboratif dengan workspace tim, kanban board, dan tracking waktu.',
          tech: ['React', 'TypeScript', 'Node.js', 'PostgreSQL', 'Socket.io'],
          category: 'fullstack',
          github: 'https://github.com/hariprediansyah/task-manager',
          live: 'https://tasks-demo.com'
        },
        {
          ...
          description: 'Aplikasi cuaca yang cantik dengan prakiraan berbasis lokasi, peta cuaca, dan peringatan cuaca buruk.',
          tech: ['Flutter', 'OpenWeather API', 'Google Maps', 'Hive DB', 'Provider'],
          category: 'mobile',
          github: 'https://github.com/hariprediansyah/weather-app'
        }
        ...
        {filteredProjects.length === 0 && (
          <div className="text-center py-12">
            <div className="text-gray-500 dark:text-gray-400 text-lg">
              {language === 'en' ? 'No projects found matching your criteria.' : 'Tidak ada proyek yang ditemukan sesuai kriteria Anda.'}
            </div>
          </div>
        )}
      </div>
