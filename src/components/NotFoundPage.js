...
import { Home, ArrowLeft, Search, Sun, Moon, FileX, Compass, RotateCcw } from 'lucide-react'

const NotFoundPage = ({ isDark, toggleTheme }) => {
    ...
    <div className='min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50 dark:from-gray-900 dark:via-gray-900 dark:to-gray-800 flex items-center justify-center relative overflow-hidden'>
      ...
      <div className='text-center z-10 max-w-2xl mx-auto px-4'>
        ...
        <motion.div
          ...
          <p className='text-xl text-blue-600 dark:text-blue-400 mb-4'>{t.subtitle}</p>
          <p className='text-gray-600 dark:text-gray-300 max-w-lg mx-auto'>{t.description}</p>
        </motion.div>
        ...
        <motion.div
          ...
          <h3 className='text-xl font-bold text-gray-900 dark:text-white mb-6'>{t.suggestions.title}</h3>
      ...
      <motion.div
        ...
        <div className='text-center'>
          <p className='text-sm text-gray-500 dark:text-gray-400'>{t.errorCode}</p>
        </div>
      </motion.div>
    </div>
  )
