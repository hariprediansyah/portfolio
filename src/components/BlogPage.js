...
import { ArrowLeft, Sun, Moon, Calendar, Clock, Tag, Search, User } from 'lucide-react'
    ...
    en: {
      ...
      articles: [
        ...
        },
        {
          ...
          excerpt:
            'Best practices for building scalable and secure APIs with Laravel, including authentication, validation, and documentation.',
        ...
        },
        {
          ...
          excerpt:
            'Understanding Promises, async/await, and other asynchronous patterns in modern JavaScript development.',
        ...
        },
        {
          ...
          excerpt:
            'Learn the fundamentals of microservices architecture and when to choose it over monolithic applications.',
    ...
    id: {
      ...
      articles: [
        ...
        },
        {
          ...
          excerpt:
            'Best practice untuk membangun API yang scalable dan aman dengan Laravel, termasuk autentikasi, validasi, dan dokumentasi.',
        ...
        },
        {
          ...
          excerpt:
            'Memahami Promises, async/await, dan pola asynchronous lainnya dalam pengembangan JavaScript modern.',
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8'>
            {filteredArticles.map((article, index) => (
              <motion.article
                ...
                <div className='p-6'>
                  <h3 className='text-lg font-bold text-gray-900 dark:text-white mb-3 line-clamp-2'>{article.title}</h3>
                  <p className='text-gray-600 dark:text-gray-300 mb-4 text-sm line-clamp-3'>{article.excerpt}</p>
